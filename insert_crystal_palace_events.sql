-- CONSULTA CORRECTA PARA INSERTAR EVENTOS DEL PARTIDO CRYSTAL PALACE VS NOTTM FOREST (JORNADA 2)
-- Basado en los datos que proporcionaste, adaptado al partido real que existe

-- Verificar el partido correcto
