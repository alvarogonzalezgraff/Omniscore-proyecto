...
try:
    ...
    print("=== CORRIGIENDO DATOS DE EVENTOS DE LALIGA EA SPORTS ===")
    ...
    cursor.execute('''
        ...
        WHERE m.league_id = (SELECT id FROM leagues WHERE name = 'LaLiga EA Sports')
    ...
    js_content = f"window.leagueData = window.leagueData || {{}};\nwindow.leagueData.ligaEASports = {json.dumps(premier_data, indent=2, default=str)};"
    
    with open('c:/Users/pc/Desktop/proyecto/assets/js/leagues/liga-ea-sports.js', 'w', encoding='utf-8') as f:
        f.write(js_content)
    
    print(f"✅ Se han corregido {len(matches)} partidos de LaLiga EA Sports")
    print(f"✅ Archivo liga-ea-sports.js actualizado con datos correctos de eventos")
